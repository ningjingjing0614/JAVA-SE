public class prac36 {
        ...
        //    1. 抛异常，通知对方出错（我们选用这种）
        //    2. 尝试修复参数
        public prac36(int year, int month, int day) {
        ...
        public int 计算相差天数(prac36 from) {
            ...
            prac36 fromCopy = new prac36(from);
            //prac36 fromCopy = from;     // 只是让 fromCopy 指向 from 指向的对象了
        ...
        //       如果 this == from，返回 0
        //       如果 this > from，返回任意正数
        public int compareTo(prac36 from) {
            // this 和 from 在进行比较
